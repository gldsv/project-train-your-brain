from train_your_brain.data import get_show_url, get_previous_diffusions, read_diffusion_history, save_diffusion_to_history
import os
...
if __name__ == '__main__':
    ...
    diffusions_df = get_previous_diffusions(show_url, number_diffusions)
